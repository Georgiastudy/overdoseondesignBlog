  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved request as @request" do
        ...
        post :create, {:request => { "name" => "invalid value" }}, valid_session
        assigns(:request).should be_a_new(Request)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested request" do
        ...
        Request.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => request.to_param, :request => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the request as @request" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Request.any_instance.stub(:save).and_return(false)
        put :update, {:id => request.to_param, :request => { "name" => "invalid value" }}, valid_session
        assigns(:request).should eq(request)
      end
